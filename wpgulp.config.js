...
module.exports = {
	...
	// Project options.
	projectURL: 'localhost/projects/awd/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'AWD-Starter', // Your textdomain here.
	translationFile: 'WPGULP.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'AWD-Starter', // Package name.
	bugReport: 'https://AhmadAwais.com/contact/', // Where can users report bugs.
	lastTranslator: 'ChrisDMorrall <chris@chrismorrall.me>', // Last translator Email ID.
	team: 'ChrisDMorrall <chris@chrismorrall.me>', // Team's Email ID.
